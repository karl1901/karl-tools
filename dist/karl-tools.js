...
var Ct = (t, e, r) => cn(t, typeof e != "symbol" ? e + "" : e, r);
const ss = (t, e, r) => {
  try {
...
}, fs = async (t, e) => navigator.clipboard.writeText(t).then(() => {
  e && e(t);
}).catch((r) => {
  console.error(r);
}), ps = (t, e, r, n, o) => {
  ...
  return n.sort((o, i) => {
    ...
    if (typeof a > "u" || typeof s > "u")
      return a === s ? 0 : a === void 0 ? 1 : -1;
    if (typeof a == "number" && typeof s == "number")
      return e === "ascending" ? a - s : s - a;
    if (typeof a == "string" && typeof s == "string") {
      const c = a.localeCompare(s);
...
const Tn = (t, e, r, { allOwnKeys: n } = {}) => (be(e, (o, i) => {
  ...
  for (; e-- > 0; )
    r[e] = t[e];
  return r;
}, Cn = /* @__PURE__ */ ((t) => (e) => t && e instanceof t)(typeof Uint8Array < "u" && wt(Uint8Array)), _n = (t, e) => {
...
), _t = (({ hasOwnProperty: t }) => (e, r) => t.call(e, r))(Object.prototype), Un = $("RegExp"), Ar = (t, e) => {
...
}, Wn = (t, e) => t != null && Number.isFinite(t = +t) ? t : e, He = "abcdefghijklmnopqrstuvwxyz", $t = "0123456789", Or = {
  DIGIT: $t,
  ALPHA: He,
  ALPHA_DIGIT: He + He.toUpperCase() + $t
...
const zn = (t) => {
  ...
  return r(t, 0);
}, Gn = $("AsyncFunction"), Jn = (t) => t && (Me(t) || I(t)) && I(t.then) && I(t.catch), f = {
  isArray: le,
  isArrayBuffer: vr,
  isBuffer: fn,
  isFormData: wn,
...
function ke(t, e, r) {
  ...
  function l(d, m, b) {
    ...
    if (d && !b && typeof d == "object") {
      ...
      else if (f.isArray(d) && Kn(d) || (f.isFileList(d) || f.endsWith(m, "[]")) && (S = f.toArray(d)))
        return m = Tr(m), S.forEach(function(g, x) {
          !(f.isUndefined(g) || g === null) && e.append(
            // eslint-disable-next-line no-nested-ternary
            a === !0 ? Bt([m], x, i) : a === null ? m : m + "[]",
            u(g)
          );
        }), !1;
    }
    return st(d) ? !0 : (e.append(Bt(b, m, i), u(d)), !1);
  }
  const y = [], p = Object.assign(Qn, {
    defaultVisitor: l,
    convertValue: u,
    isVisitable: st
  });
  function h(d, m) {
    if (!f.isUndefined(d)) {
      ...
      y.push(d), f.forEach(d, function(S, R) {
...
function ao(t, e) {
  return ke(t, new _.classes.URLSearchParams(), Object.assign({
    visitor: function(r, n, o, i) {
      return _.isNode && f.isBuffer(r) ? (this.append(n, r.toString("base64")), !1) : i.defaultVisitor.apply(this, arguments);
    }
  }, e));
}
function so(t) {
...
const we = {
  ...
  transformRequest: [function(e, r) {
    ...
    if (i && f.isHTMLForm(e) && (e = new FormData(e)), f.isFormData(e))
      return o ? JSON.stringify(Nr(e)) : e;
...
class D {
  ...
  set(e, r, n) {
    ...
    function i(s, c, u) {
      ...
      (!y || o[y] === void 0 || u === !0 || u === void 0 && o[y] !== !1) && (o[y || c] = xe(s));
    }
...
const $r = (t) => {
  ...
  e.headers = a = D.from(a), e.url = Fr(_r(e.baseURL, e.url), t.params, t.paramsSerializer), s && a.set(
    "Authorization",
  ...
  if (_.hasStandardBrowserEnv && (n && f.isFunction(n) && (n = n(e)), n || n !== !1 && wo(e.url))) {
  ...
  return new Promise(function(r, n) {
    ...
    "onloadend" in l ? l.onloadend = y : l.onreadystatechange = function() {
    ...
    }, i === void 0 && a.setContentType(null), "setRequestHeader" in l && f.forEach(a.toJSON(), function(d, m) {
      l.setRequestHeader(m, d);
    }), f.isUndefined(o.withCredentials) || (l.withCredentials = !!o.withCredentials), s && s !== "json" && (l.responseType = o.responseType), typeof o.onDownloadProgress == "function" && l.addEventListener("progress", Ne(o.onDownloadProgress, !0)), typeof o.onUploadProgress == "function" && l.upload && l.upload.addEventListener("progress", Ne(o.onUploadProgress)), (o.cancelToken || o.signal) && (c = (h) => {
      l && (n(!h || h.type ? new ce(null, t, l) : h), l.abort(), l = null);
    }, o.cancelToken && o.cancelToken.subscribe(c), o.signal && (o.signal.aborted ? c() : o.signal.addEventListener("abort", c)));
    const p = go(o.url);
    if (p && _.protocols.indexOf(p) === -1) {
      n(new v("Unsupported protocol " + p + ":", v.ERR_BAD_REQUEST, t));
      return;
    }
    l.send(i || null);
  });
...
const Do = async (t) => {
  ...
  let R;
  try {
    if (c && Fo && r !== "get" && r !== "head" && (R = await No(l, n)) !== 0) {
      let F = new Request(e, {
        method: "POST",
        body: n,
        duplex: "half"
      }), N;
      f.isFormData(n) && (N = F.headers.get("content-type")) && l.setContentType(N), F.body && (n = qt(F.body, jt, Wt(
        R,
        Ne(c)
      ), null, lt));
    }
    f.isString(y) || (y = y ? "cors" : "omit"), b = new Request(e, {
      ...p,
      signal: h,
    ...
    if (ct && (s || x)) {
      ...
      const N = f.toFiniteNumber(g.headers.get("content-length"));
      g = new Response(
        qt(g.body, jt, s && Wt(
          N,
          Ne(s, !0)
    ...
    u = u || "text";
    let M = await Ie[f.findKey(Ie, u) || "text"](g, t);
    return !x && S(), d && d(), await new Promise((F, N) => {
      Cr(F, N, {
        data: M,
    ...
    throw S(), g && g.name === "TypeError" && /fetch/i.test(g.message) ? Object.assign(
      new v("Network Error", v.ERR_NETWORK, t, b),
      {
        cause: g.cause || g
      }
    ) : v.from(g, g && g.code, t, b);
  }
}), ut = {
  http: Vn,
  xhr: Ro,
...
const Ht = (t) => `- ${t}`, Co = (t) => f.isFunction(t) || t === null || t === !1, Lr = {
  getAdapter: (t) => {
    t = f.isArray(t) ? t : [t];
    const { length: e } = t;
    let r, n;
    ...
    for (let i = 0; i < e; i++) {
      r = t[i];
      let a;
      if (n = r, !Co(r) && (n = ut[(a = String(r)).toLowerCase()], n === void 0))
...
A.mergeConfig = Z;
A.AxiosHeaders = D;
A.formToJSON = (t) => Nr(f.isHTMLForm(t) ? new FormData(t) : t);
...
var Mo = Error, ko = EvalError, qo = RangeError, Wo = ReferenceError, kr = SyntaxError, Se = TypeError, jo = URIError, Ho = function() {
  ...
  return !0;
}, Vt = typeof Symbol < "u" && Symbol, zo = Ho, Go = function() {
  return typeof Vt != "function" || typeof Symbol != "function" || typeof Vt("foo") != "symbol" || typeof Symbol("bar") != "symbol" ? !1 : zo();
}, Ve = {
  __proto__: null,
  foo: {}
}, Jo = Object, Vo = function() {
  return { __proto__: Ve }.foo === Ve.foo && !(Ve instanceof Jo);
  ...
  return o;
}, ri = ti, Rt = Function.prototype.bind || ri, ni = Function.prototype.call, oi = Object.prototype.hasOwnProperty, ii = Rt, ai = ii.call(ni, oi), w, si = Mo, li = ko, ci = qo, ui = Wo, ie = kr, oe = Se, fi = jo, qr = Function, Ke = function(t) {
  try {
...
var Qe = function() {
...
}() : Qe, te = Go(), yi = Vo(), P = Object.getPrototypeOf || (yi ? function(t) {
  return t.__proto__;
} : null), ne = {}, di = typeof Uint8Array > "u" || !P ? w : P(Uint8Array), Y = {
  __proto__: null,
  "%AggregateError%": typeof AggregateError > "u" ? w : AggregateError,
  "%Array%": Array,
  "%ArrayBuffer%": typeof ArrayBuffer > "u" ? w : ArrayBuffer,
  "%ArrayIteratorPrototype%": te && P ? P([][Symbol.iterator]()) : w,
  ...
  "%isFinite%": isFinite,
  "%isNaN%": isNaN,
  "%IteratorPrototype%": te && P ? P(P([][Symbol.iterator]())) : w,
  "%JSON%": typeof JSON == "object" ? JSON : w,
  "%Map%": typeof Map > "u" ? w : Map,
  "%MapIteratorPrototype%": typeof Map > "u" || !te || !P ? w : P((/* @__PURE__ */ new Map())[Symbol.iterator]()),
  "%Math%": Math,
  "%Number%": Number,
  "%Object%": Object,
  ...
  "%SetIteratorPrototype%": typeof Set > "u" || !te || !P ? w : P((/* @__PURE__ */ new Set())[Symbol.iterator]()),
  "%SharedArrayBuffer%": typeof SharedArrayBuffer > "u" ? w : SharedArrayBuffer,
  "%String%": String,
  "%StringIteratorPrototype%": te && P ? P(""[Symbol.iterator]()) : w,
  "%Symbol%": te ? Symbol : w,
  "%SyntaxError%": ie,
  "%ThrowTypeError%": pi,
  "%TypedArray%": di,
...
var mi = function t(e) {
...
}, Ee = Rt, Ce = ai, gi = Ee.call(Function.call, Array.prototype.concat), vi = Ee.call(Function.apply, Array.prototype.splice), Xt = Ee.call(Function.call, String.prototype.replace), _e = Ee.call(Function.call, String.prototype.slice), bi = Ee.call(Function.call, RegExp.prototype.exec), wi = /[^%.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|%$))/g, Si = /\\(\\)?/g, Ei = function(e) {
  ...
  for (var l = 1, y = !0; l < n.length; l += 1) {
    var p = n[l], h = _e(p, 0, 1), d = _e(p, -1);
    if ((h === '"' || h === "'" || h === "`" || d === '"' || d === "'" || d === "`") && h !== d)
      throw new ie("property names with quotes must have matching quotes");
    if ((p === "constructor" || !y) && (c = !0), o += "." + p, a = "%" + o + "%", Ce(Y, a))
      s = Y[a];
    else if (s != null) {
      if (!(p in s)) {
        if (!r)
...
Hr.hasArrayLengthDefineBug = function() {
  if (!yt)
    return null;
  try {
...
var Ti = Hr, xi = ue, tr = Pi, Fi = Ti(), rr = jr, nr = Se, Di = xi("%Math.floor%"), Ni = function(e, r) {
  if (typeof e != "function")
    throw new nr("`fn` is not a function");
  if (typeof r != "number" || r < 0 || r > 4294967295 || Di(r) !== r)
...
(function(t) {
  var e = Rt, r = ue, n = Ni, o = Se, i = r("%Function.prototype.apply%"), a = r("%Function.prototype.call%"), s = r("%Reflect.apply%", !0) || e.call(a, i), c = Pt(), u = r("%Math.max%");
...
var mt = Li, pr = mt.custom, yr = Qr(pr) ? pr : null, Ji = function t(e, r, n, o) {
  var i = r || {};
  ...
  if (typeof o > "u")
    ...
    return "[Circular]";
  function p(C, q, W) {
    if (q && (o = Gi.call(o), o.push(q)), W) {
      var pe = {
        depth: i.depth
      };
      return H(i, "quoteStyle") && (pe.quoteStyle = i.quoteStyle), t(C, pe, n + 1, o);
    }
    return t(C, i, n + 1, o);
  }
  ...
  if (Qr(e)) {
    var m = ae ? z.call(String(e), /^(Symbol\(.*\))_[^)]*$/, "$1") : ht.call(e);
    return typeof e == "object" && !ae ? de(m) : m;
  }
  if (la(e)) {
    for (var b = "<" + sr.call(String(e.nodeName)), S = e.attributes || [], R = 0; R < S.length; R++)
      b += " " + S[R].name + "=" + Kr(Vi(S[R].value), "double", i);
    return b += ">", e.childNodes && e.childNodes.length && (b += "..."), b += "</" + sr.call(String(e.nodeName)) + ">", b;
  }
  if (gt(e)) {
    if (e.length === 0)
      return "[]";
    var g = Oe(e, p);
    return y && !ua(g) ? "[" + vt(g, y) + "]" : "[ " + U.call(g, ", ") + " ]";
  }
  if (Qi(e)) {
    var x = Oe(e, p);
    return !("cause" in Error.prototype) && "cause" in e && !Vr.call(e, "cause") ? "{ [" + String(e) + "] " + U.call(lr.call("[cause]: " + p(e.cause), x), ", ") + " }" : x.length === 0 ? "[" + String(e) + "]" : "{ [" + String(e) + "] " + U.call(x, ", ") + " }";
  }
  ...
  if (na(e)) {
    var M = [];
    return or && or.call(e, function(C, q) {
      M.push(p(q, e, !0) + " => " + p(C, e));
    }), hr("Map", $e.call(e), M, y);
  }
  if (aa(e)) {
    var F = [];
    return ir && ir.call(e, function(C) {
      F.push(p(C, e));
    }), hr("Set", Be.call(e), F, y);
  }
  if (oa(e))
    return tt("WeakMap");
  if (sa(e))
  ...
  if (!Ki(e) && !dr(e)) {
    var N = Oe(e, p), J = ur ? ur(e) === Object.prototype : e instanceof Object || e.constructor === Object, V = e instanceof Object ? "" : "null prototype", k = !J && T && Object(e) === e && T in e ? Ft.call(G(e), 8, -1) : V ? "Object" : "", Ae = J || typeof e.constructor != "function" ? "" : e.constructor.name ? e.constructor.name + " " : "", ee = Ae + (k || V ? "[" + U.call(lr.call([], k || [], V || []), ": ") + "] " : "");
    return N.length === 0 ? ee + "{}" : y ? ee + "{" + vt(N, y) + "}" : ee + "{ " + U.call(N, ", ") + " }";
  }
  return String(e);
};
function Kr(t, e, r) {
...
function Oe(t, e) {
  ...
  for (var c in t)
    H(t, c) && (r && String(Number(c)) === c && c < t.length || ae && a["$" + c] instanceof Symbol || (Jr.call(/[^\w$]/, c) ? n.push(e(c, t) + ": " + e(t[c], t)) : n.push(c + ": " + e(t[c], t))));
  if (typeof et == "function")
    for (var u = 0; u < i.length; u++)
      Vr.call(t, i[u]) && n.push("[" + e(i[u]) + "]: " + e(t[i[u]], t));
  return n;
}
var Zr = ue, fe = _i, pa = Ji, ya = Se, Re = Zr("%WeakMap%", !0), Pe = Zr("%Map%", !0), da = fe("WeakMap.prototype.get", !0), ha = fe("WeakMap.prototype.set", !0), ma = fe("WeakMap.prototype.has", !0), ga = fe("Map.prototype.get", !0), va = fe("Map.prototype.set", !0), ba = fe("Map.prototype.has", !0), Dt = function(t, e) {
  ...
  RFC1738: rt.RFC1738,
  RFC3986: rt.RFC3986
}, Pa = Nt, nt = Object.prototype.hasOwnProperty, K = Array.isArray, B = function() {
  ...
  for (var s = "", c = 0; c < a.length; c += ot) {
    for (var u = a.length >= ot ? a.slice(c, c + ot) : a, l = [], y = 0; y < u.length; ++y) {
      var p = u.charCodeAt(y);
      if (p === 45 || p === 46 || p === 95 || p === 126 || p >= 48 && p <= 57 || p >= 65 && p <= 90 || p >= 97 && p <= 122 || i === Pa.RFC1738 && (p === 40 || p === 41)) {
      ...
      if (p < 2048) {
        l[l.length] = B[192 | p >> 6] + B[128 | p & 63];
        continue;
      }
      if (p < 55296 || p >= 57344) {
        l[l.length] = B[224 | p >> 12] + B[128 | p >> 6 & 63] + B[128 | p & 63];
        continue;
      }
      y += 1, p = 65536 + ((p & 1023) << 10 | u.charCodeAt(y) & 1023), l[l.length] = B[240 | p >> 18] + B[128 | p >> 12 & 63] + B[128 | p >> 6 & 63] + B[128 | p & 63];
    }
    s += l.join("");
  }
  return s;
  ...
  maybeMap: Ba,
  merge: xa
}, rn = Aa, De = tn, ge = Nt, La = Object.prototype.hasOwnProperty, nn = {
  brackets: function(e) {
    return e + "[]";
  },
  comma: "comma",
...
}, it = {}, qa = function t(e, r, n, o, i, a, s, c, u, l, y, p, h, d, m, b, S, R) {
  for (var g = e, x = R, M = 0, F = !1; (x = x.get(it)) !== void 0 && !F; ) {
    var N = x.get(e);
    if (M += 1, typeof N < "u") {
      if (N === M)
  ...
  if (typeof l == "function" ? g = l(r, g) : g instanceof Date ? g = h(g) : n === "comma" && L(g) && (g = De.maybeMap(g, function(je) {
    return je instanceof Date ? h(je) : je;
  })), g === null) {
    if (a)
      return u && !b ? u(r, O.encoder, S, "key", d) : r;
    g = "";
  }
  if (ka(g) || De.isBuffer(g)) {
    if (u) {
      var J = b ? r : u(r, O.encoder, S, "key", d);
      return [m(J) + "=" + m(u(g, O.encoder, S, "value", d))];
    }
  ...
  var k;
  if (n === "comma" && L(g))
    b && u && (g = De.maybeMap(g, u)), k = [{ value: g.length > 0 ? g.join(",") || null : void 0 }];
  else if (L(l))
    k = l;
  else {
  ...
  var ee = c ? r.replace(/\./g, "%2E") : r, C = o && L(g) && g.length === 1 ? ee + "[]" : ee;
  if (i && L(g) && g.length === 0)
    return C + "[]";
  for (var q = 0; q < k.length; ++q) {
    var W = k[q], pe = typeof W == "object" && typeof W.value < "u" ? W.value : g[W];
    if (!(s && pe === null)) {
      var We = p && c ? W.replace(/\./g, "%2E") : W, sn = L(g) ? typeof n == "function" ? n(C, We) : C : C + (p ? "." + We : "[" + We + "]");
      R.set(e, M);
      var It = rn();
      It.set(it, R), on(V, t(
        pe,
...
}, se = tn, bt = Object.prototype.hasOwnProperty, Ha = Array.isArray, E = {
  allowDots: !1,
  allowEmptyArrays: !1,
  allowPrototypes: !1,
  allowSparse: !1,
...
}, Ga = "utf8=%26%2310003%3B", Ja = "utf8=%E2%9C%93", Va = function(e, r) {
  ...
  if (r.charsetSentinel)
    for (c = 0; c < a.length; ++c)
      a[c].indexOf("utf8=") === 0 && (a[c] === Ja ? u = "utf-8" : a[c] === Ga && (u = "iso-8859-1"), s = c, c = a.length);
  for (c = 0; c < a.length; ++c)
    if (c !== s) {
      var l = a[c], y = l.indexOf("]="), p = y === -1 ? l.indexOf("=") : y + 1, h, d;
      p === -1 ? (h = r.decoder(l, E.decoder, u, "key"), d = r.strictNullHandling ? null : "") : (h = r.decoder(l.slice(0, p), E.decoder, u, "key"), d = se.maybeMap(
        an(l.slice(p + 1), r),
        function(b) {
          return r.decoder(b, E.decoder, u, "value");
        }
      )), d && r.interpretNumericEntities && u === "iso-8859-1" && (d = za(d)), l.indexOf("[]=") > -1 && (d = Ha(d) ? [d] : d);
      var m = bt.call(n, h);
      m && r.duplicates === "combine" ? n[h] = se.combine(n[h], d) : (!m || r.duplicates === "last") && (n[h] = d);
    }
  return n;
}, Ka = function(t, e, r, n) {
  ...
  if (e) {
    ...
    for (var y = 0; n.depth > 0 && (c = s.exec(i)) !== null && y < n.depth; ) {
      if (y += 1, !n.plainObjects && bt.call(Object.prototype, c[1].slice(1, -1)) && !n.allowPrototypes)
        return;
      l.push(c[1]);
    }
  ...
  for (var n = typeof t == "string" ? Va(t, r) : t, o = r.plainObjects ? /* @__PURE__ */ Object.create(null) : {}, i = Object.keys(n), a = 0; a < i.length; ++a) {
    var s = i[a], c = Qa(s, n[s], r, typeof t == "string");
    o = se.merge(o, c, r);
  }
  return r.allowSparse === !0 ? o : se.compact(o);
}, Za = ja, es = Ya, ts = Nt, rs = {
  formats: ts,
  parse: es,
  stringify: Za
};
const ns = /* @__PURE__ */ Lo(rs), os = A.create({
  timeout: 60 * 1e3
  // 请求超时时间
}), Ss = (t) => {
  let {
  ...
  const y = c || os;
  let p = n;
  n instanceof FormData || (p = ns.stringify(n, u)), o.toUpperCase() === "GET" && (r += `?${p}`, p = "");
  ...
  m.then((b) => {
    ...
    const S = a ? a(b) : { code: 500, data: b, message: `An error occurred on the request: ${b}`, success: !1 };
    s && s(S);
  });
}, Es = (t, e) => t.length === 0 ? Promise.resolve([]) : new Promise((r) => {
  let n = 0;
  const o = [];
  let i = 0;
  async function a() {
...
const Os = async (t, e) => {
  ...
  const r = Math.ceil(t.size / e), n = typeof navigator < "u" && navigator.hardwareConcurrency ? Math.max(2, Math.min(navigator.hardwareConcurrency, 16)) : 8, o = Array.from({ length: r }, (l, y) => {
    const p = y * e, h = Math.min(p + e, t.size), d = t.slice(p, h);
    return { start: p, end: h, index: y, blob: d };
  });
  function i(l) {
    return new Promise((y, p) => {
      const h = new FileReader();
      h.onload = () => y(h.result), h.onerror = () => p(h.error), h.readAsArrayBuffer(l);
    });
  }
  const a = Array.from({ length: n }, is), s = new Array(r);
  let c = 0;
  async function u(l) {
    for (; c < o.length; ) {
      const y = c++, p = o[y], h = await i(p.blob), d = await new Promise((m) => {
        l.onmessage = (b) => m(b.data.hash), l.postMessage({ index: p.index, buffer: h }, [h]);
      });
      s[y] = { ...p, hash: d };
    }
  }
  return await Promise.all(a.map(u)), a.forEach((l) => l.terminate()), s;
};
function is() {
  return new Worker(new URL(
    /* @vite-ignore */
    "/assets/fileChunkWorker-DsTTr6_u.js",
    import.meta.url
  ), { type: "module" });
}
export {
  As as EventEmitter,
  vs as checkLocalInfo,
  Es as concurRequest,
  fs as copyText,
  Os as cutAndHashFile,
  ls as formatCommas,
  ss as formatDate,
  us as formatFileSize,
  gs as loadLocalInfo,
  ws as maskStr,
  cs as openChooseFile,
  bs as removeLocalInfo,
  ms as saveLocalInfo,
  ps as searchKeywordInfo,
  ys as searchKeywordList,
  ds as searchTypeList,
  Ss as send,
  hs as sortList
};
